                        ...
                        <div class="card-body m-5" id="printThis">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <h2 class="mt-3" style="text-indent: 40px;">This is to certify that <span class="fw-bold" style="font-size:25px">Mark Andaya</span>, is a permanent resident of 
                                    <span class="fw-bold" style="font-size:25px">Brgy. Turac</span> and that he/she is known to me to be of good moral character.</h2>
                                    ...
                                    <h2 class="mt-5">Given this <span class="fw-bold" style="font-size:25px">06/28/2023.</span></h2>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="p-3 text-left">
                                        <h2 class="fw-bold mb-0 text-uppercase">Hesus Dipatuli</h2>
                                ...
                                <div class="col-md-12 d-flex flex-wrap justify-content-end">
                                    <div class="p-3 text-center">
                                        ...
                                        <h2 class="fw-bold mb-0">Mark Andaya</h2>
